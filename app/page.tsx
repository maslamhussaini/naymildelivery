...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF9F5] text-gray-800 font-sans selection:bg-orange-200">
      {/* Navbar */}
      <header
      ...
      >
        <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
          <a href="#" className="flex items-center gap-2">
            ...
            <div className="relative h-10 w-32 md:h-12 md:w-40 flex items-center">
              <span className="text-2xl font-bold text-orange-600 flex items-center gap-2">
                <div className="h-10 w-10 bg-orange-600 text-white rounded-lg flex items-center justify-center font-black text-xl italic shadow-lg shadow-orange-600/30">N</div>
                Naymil
              </span>
            </div>
          </a>
          ...
          <nav className="hidden md:flex items-center gap-8 font-medium">
            ...
            <a href="#contact" className="px-6 py-2.5 bg-orange-500 text-white rounded-full hover:bg-orange-600 transition-all shadow-lg shadow-orange-500/30 hover:-translate-y-0.5">
              Contact Us
            </a>
          </nav>
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          ...
          >
            ...
            <a href="#contact" onClick={() => setMobileMenuOpen(false)} className="bg-orange-500 text-white py-3 rounded-full text-center">Contact Us</a>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <main>
        ...
        <section id="home" className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
          ...
          <div className="absolute top-0 right-0 -translate-y-12 translate-x-1/3 w-[600px] h-[600px] bg-orange-100 rounded-full blur-3xl opacity-50 -z-10"></div>
          <div className="absolute bottom-0 left-0 translate-y-1/3 -translate-x-1/3 w-[400px] h-[400px] bg-orange-200 rounded-full blur-3xl opacity-40 -z-10"></div>
          ...
          <div className="container mx-auto px-6 md:px-12 grid lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              className="max-w-2xl"
            >
              <motion.div variants={fadeUpVariant} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-100 text-orange-600 font-medium text-sm mb-6 border border-orange-200">
                <span className="w-2 h-2 rounded-full bg-orange-500 animate-pulse"></span>
                Your Package, Our Priority
              </motion.div>
              
              <motion.h1 variants={fadeUpVariant} className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 text-gray-900">
                Reliable Delivery <br />
                <span className="text-orange-500">Riders & Drivers</span> <br />
                for Your Business
              </motion.h1>
              ...
              <motion.div variants={fadeUpVariant} className="flex flex-wrap gap-4">
                <a href="#contact" className="px-8 py-4 bg-orange-500 text-white rounded-full font-semibold hover:bg-orange-600 transition-all shadow-xl shadow-orange-500/20 hover:-translate-y-1 flex items-center gap-2">
                  Partner With Us <ArrowRight size={20} />
                </a>
                <a href="#services" className="px-8 py-4 bg-white text-gray-800 rounded-full font-semibold hover:bg-gray-50 transition-all shadow-md shadow-gray-200 border border-gray-100 flex items-center gap-2">
                  Our Services
                </a>
              </motion.div>
              ...
              <motion.div variants={fadeUpVariant} className="mt-12 flex items-center gap-4 text-sm font-medium text-gray-500">
                ...
                <div>
                  <div className="text-orange-500 font-bold text-lg">500+</div>
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-orange-400 to-orange-500 rounded-3xl shadow-2xl rotate-3 transform-gpu overflow-hidden">
                   ...
                   <div className="bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-2xl shadow-xl flex flex-col gap-6 text-white transform -rotate-3 transition-transform hover:rotate-0 duration-500">
                      <div className="flex items-center gap-4 border-b border-white/20 pb-4">
                        ...
                        <div>
                          ...
                          <div className="text-orange-100 text-sm">On-time, every time</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-4 py-2">
                        ...
                        <div>
                          ...
                          <div className="text-orange-100 text-sm">Monitor your shipments</div>
                        </div>
                      </div>
                   </div>
                </div>
              ...
              >
                ...
                <div>
                  <div className="font-bold text-gray-800">Bulk Orders</div>
        ...
        <section id="services" className="py-20 bg-white">
          <div className="container mx-auto px-6 md:px-12">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-orange-500 font-bold uppercase tracking-wider text-sm mb-2">What We Do</h2>
              <h3 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">Our Services</h3>
            ...
            >
              {[
                ...
                <motion.div 
                  ...
                  className="bg-[#FFF9F5] p-8 rounded-3xl hover:shadow-2xl hover:shadow-orange-500/10 transition-all duration-300 border border-orange-50/50 group hover:-translate-y-2 relative overflow-hidden"
                >
                  <div className="absolute top-0 right-0 p-8 opacity-5 text-orange-500 font-black text-9xl transform translate-x-12 -translate-y-12 group-hover:scale-110 transition-transform duration-500">
                    {index + 1}
                  </div>
                  <div className="w-20 h-20 bg-white shadow-sm rounded-2xl flex items-center justify-center text-orange-500 mb-6 group-hover:bg-orange-500 group-hover:text-white transition-colors duration-300">
                    {service.icon}
                  </div>
                  <h4 className="text-2xl font-bold mb-4 text-gray-900">{service.title}</h4>
                  <p className="text-gray-600 mb-6 leading-relaxed relative z-10">{service.desc}</p>
                  
                  <div className="relative z-10">
                    <h5 className="font-semibold text-gray-900 mb-3 text-sm uppercase tracking-wide">Best For:</h5>
        ...
        <section className="py-20 bg-[#FFF9F5] relative overflow-hidden">
          <div className="container mx-auto px-6 md:px-12 grid lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              variants={staggerContainer}
            >
              <motion.h2 variants={fadeUpVariant} className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
                Why Choose <br/><span className="text-orange-500">Naymil</span>?
              </motion.h2>
              <motion.p variants={fadeUpVariant} className="text-gray-600 text-lg mb-8">
              ...
              <motion.div variants={staggerContainer} className="grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  <motion.div key={index} variants={fadeUpVariant} className="flex items-start gap-3 bg-white p-4 rounded-xl shadow-sm border border-orange-50">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              variants={staggerContainer}
              className="bg-white p-8 md:p-12 rounded-3xl shadow-xl shadow-orange-100 border border-orange-50"
            >
              <motion.h3 variants={fadeUpVariant} className="text-2xl font-bold mb-8 text-gray-900 border-b pb-4">Industries We Serve</motion.h3>
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  <motion.div 
                    key={i} 
                    variants={fadeUpVariant}
                    className="flex flex-col items-center justify-center text-center gap-3 p-6 rounded-2xl bg-gray-50 hover:bg-orange-50 hover:text-orange-600 transition-colors group cursor-default"
                  >
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 w-full p-10">
                  <div className="inline-block bg-orange-500 text-white px-6 py-2 rounded-full font-bold text-sm uppercase tracking-wide mb-4">
                    Who We Are
                  </div>
              ...
              <motion.div
                ...
                variants={staggerContainer}
              >
                <motion.h2 variants={fadeUpVariant} className="text-orange-500 font-bold uppercase tracking-wider text-sm mb-2">About Us</motion.h2>
                <motion.h3 variants={fadeUpVariant} className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">Your Trusted Delivery Partner</motion.h3>
                
                <motion.p variants={fadeUpVariant} className="text-gray-600 text-lg mb-8 leading-relaxed">
                  Naymil Delivery Services Co. is a professional delivery and logistics support company dedicated to helping businesses manage their delivery operations efficiently. We specialize in providing trained riders and drivers along with their vehicles, ensuring that businesses can focus on their customers while we handle transportation and delivery.
                </motion.p>
                ...
                <div className="space-y-8">
                  <motion.div variants={fadeUpVariant} className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">To deliver reliable logistics support by providing professional riders and drivers that help businesses grow and succeed.</p>
                    </div>
                  </motion.div>
                  ...
                  <motion.div variants={fadeUpVariant} className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">To become a trusted delivery partner for businesses by offering high-quality delivery services and dependable staff.</p>
                    </div>
                  </motion.div>
                </div>
        ...
        <section id="contact" className="py-24 bg-[#FFF9F5]">
          <div className="container mx-auto px-6 md:px-12">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              >
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-orange-50 hover:border-orange-200 transition-colors">
                  ...
                  <a href="tel:+971543127890" className="text-2xl font-bold text-gray-900 hover:text-orange-500 transition-colors">+971 54 312 7890</a>
                </div>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-orange-50 hover:border-orange-200 transition-colors">
                  ...
                  <a href="mailto:connect@naymil.com" className="text-xl font-bold text-gray-900 hover:text-orange-500 transition-colors">connect@naymil.com</a>
                </div>
                ...
                <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="text" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-orange-500 focus:bg-white transition-all" placeholder="John Doe" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Phone Number</label>
                      <input type="tel" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-orange-500 focus:bg-white transition-all" placeholder="+971 5x xxx xxxx" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Email Address</label>
                    <input type="email" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-orange-500 focus:bg-white transition-all" placeholder="you@company.com" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Message</label>
                    <textarea rows={5} className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-orange-500 focus:bg-white transition-all resize-none" placeholder="Tell us about your delivery needs..."></textarea>
                  </div>
                  <button className="w-full bg-orange-500 text-white font-bold text-lg py-4 rounded-xl hover:bg-orange-600 transition-colors shadow-lg shadow-orange-500/30 flex justify-center items-center gap-2">
                    Submit Request
                  </button>
                </form>
              </motion.div>
            ...
            >
              <div className="w-12 h-12 bg-orange-100 text-orange-500 rounded-full flex shrink-0 items-center justify-center">
                <MapPin size={24} />
              </div>
              <div>
                <h4 className="text-sm font-bold text-gray-900">Head Office Location</h4>
                <p className="text-gray-600">Office No - 16F-B-126, Empire Heights A, Business Bay, Dubai</p>
              </div>
            </motion.div>
        ...
        <div className="container mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            <span className="text-2xl font-bold flex items-center gap-2 text-white">
              <div className="h-8 w-8 bg-orange-500 text-white rounded-md flex items-center justify-center font-black text-lg italic">N</div>
              Naymil
            </span>
          </div>
